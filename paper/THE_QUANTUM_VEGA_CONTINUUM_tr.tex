...
\title{THE QUANTUM VEGA CONTINUUM: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, THE QUANTUM VEGA CONTINUUM'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
